...
import com.kabukabu.driver.features.analytics.presentation.AnalyticsViewModel
            ...
            if (ui.isLoading) {
                ...
                Card(colors = CardDefaults.cardColors(containerColor = Color(0xFFF9F9F9))) {
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        data.yourEarnings?.comment?.let { comment -> Text(comment, color = Color(0xFF6A6A6A), fontSize = 12.sp) }
                    }
                }
                ...
                // Trips totals
                if (data.totalTripsData != null) {
                    val totals = data.totalTripsData
                    Card(colors = CardDefaults.cardColors(containerColor = Color(0xFFF9F9F9))) {
                        Column(modifier = Modifier.padding(16.dp)) {
