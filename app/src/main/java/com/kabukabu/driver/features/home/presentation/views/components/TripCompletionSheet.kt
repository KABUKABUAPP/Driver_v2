        ...
        Box(
            ...
            Surface(
                ...
                Column(
                    ...
                    // Price Card
                    EarningsCard(driverEarned = driverEarned)

                    Spacer(modifier = Modifier.height(16.dp))

                    // Route Card
                    TripCompletionRouteCard(
                    ...
                    RatingSection(
                        ...
                        onFeedbackChanged = { newFeedback -> selectedFeedback = newFeedback },
...
@Composable
private fun EarningsCard(driverEarned: Int) {
...
@Composable
private fun TripCompletionRouteCard(
...
private fun RatingSection(
    ...
    onFeedbackChanged: (Set<String>) -> Unit,
    negativeChips: List<String>,
    positiveChips: List<String>
) {
    TripCompletionContainerBox {
        Column(
            modifier = Modifier
            ...
            if (rating != null) {
                ...
                FlowRow(
                    ...
                    val chipsToShow = if (rating <= 2) negativeChips else positiveChips
                    ...
                    chipsToShow.forEach { label ->
                        TripCompletionFeedbackChip(
                            ...
                            onClick = {
                                onFeedbackChanged(
                                    if (selectedFeedback.contains(label)) {
